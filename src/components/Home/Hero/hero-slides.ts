...
export const heroSlides: HeroSlide[] = [
  {
    ...
    mobileProductClassName: "max-h-[min(46vw,220px)] max-w-[min(94vw,360px)]",
  ...
  },
  {
    ...
    mobileProductClassName: "max-h-[min(44vw,210px)] max-w-[min(92vw,340px)]",
  ...
  },
  {
    ...
    mobileProductClassName: "max-h-[min(48vw,230px)] max-w-[min(90vw,320px)]",
