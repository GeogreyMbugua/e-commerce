        ...
        <div className="grid grid-cols-1 gap-10 border-b border-brand-ink/10 pt-12 pb-10 sm:grid-cols-2 xl:grid-cols-4 xl:gap-19 xl:pt-22.5 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <p className="mb-6 max-w-[290px] text-custom-sm text-brand-ink/70">
              ...
              equipment for better listening.
            </p>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-brand-rust"
              >
                <svg
          ...
          <div className="w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li><a className="ease-out duration-200 hover:text-brand-rust" href="/shop-without-sidebar">The Collection</a></li>
              <li><a className="ease-out duration-200 hover:text-brand-rust" href="/blogs/blog-grid">Journal</a></li>
              <li><a className="ease-out duration-200 hover:text-brand-rust" href="/contact">Contact</a></li>
              <li><a className="ease-out duration-200 hover:text-brand-rust" href="#">Shipping & Returns</a></li>
              <li><a className="ease-out duration-200 hover:text-brand-rust" href="#">FAQ</a></li>
            </ul>
          </div>
          ...
          <div className="w-full sm:max-w-[250px] lg:justify-self-end lg:text-right">
            ...
            <p className="text-custom-sm text-brand-ink/70">
              Carefully checked pieces, honest descriptions, and a passion for
              keeping great equipment in rotation.
            </p>
            <a
              className="mt-5 inline-flex rounded-md border border-brand-rust px-5 py-3 font-medium text-brand-rust transition-colors duration-200 hover:bg-brand-rust hover:text-white"
          ...
          <ul className="hidden">
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-brand-teal ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
