          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div>
              <form>
                ...
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-lg bg-brand-ink px-6 py-3 font-medium text-white ease-out duration-200 hover:bg-brand-rust mt-7.5"
                >
                  Sign in to account
                </button>
                ...
                <a
                  href="#"
                  className="mt-4.5 block text-center text-dark-4 ease-out duration-200 hover:text-brand-rust"
                >
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="pl-2 text-dark ease-out duration-200 hover:text-brand-rust"
                  >
                    Sign Up Now!
                  </Link>
                </p>
