                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-white !border-l-0 border border-brand-ink/15 py-2.5 pl-4 pr-10 outline-none ease-in duration-200 placeholder:text-dark-4 focus:border-brand-rust focus:ring-1 focus:ring-brand-rust/20"
                    />
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-brand-gold w-4.5 h-4.5 rounded-full text-brand-ink">
                      {product.length}
                    </span>
                  </span>
