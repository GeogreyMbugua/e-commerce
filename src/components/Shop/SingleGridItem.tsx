  ...
  return (
    <article className="group flex h-full flex-col">
      <div className="relative mb-2 overflow-hidden bg-gradient-to-b from-[#fbf8f2] to-[#efe6d8] shadow-[inset_0_0_0_1px_rgba(37,36,42,0.06)]">
        <Link
          href={detailHref}
          className="relative flex aspect-square items-center justify-center p-2.5 sm:p-3"
        >
          <Image
            src={previewImage}
            alt={previewAlt}
      ...
      <div className="flex flex-1 flex-col">
        ...
        <h3 className="mb-1 text-sm font-medium leading-snug text-brand-ink hover:text-brand-rust sm:text-[15px]">
