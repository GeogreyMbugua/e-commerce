      ...
      <div className="relative mb-4 overflow-hidden rounded-lg bg-brand-cream">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-[5px] bg-white text-brand-ink shadow-1 transition-colors duration-200 hover:text-brand-rust"
          >
            <svg
          ...
          <button
            ...
            className="inline-flex rounded-[5px] bg-brand-rust px-5 py-[7px] text-sm font-medium text-white transition-colors duration-200 hover:bg-brand-ink"
          >
            Add to cart
          </button>
